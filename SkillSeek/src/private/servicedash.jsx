...
//       action: () => setViewRequests("/allrequests"),
//     },
//     {
...
const Dashboard = () => {
  ...
  // Simulate a new request coming in after 5 seconds
  // useEffect(() => {
  //   setTimeout(() => {
  //     setNewRequest(true);
      ...
      <div className="flex-1">
        ...
        <header className="bg-white shadow-lg py-4 px-6 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <img
              src="https://imgv3.fotor.com/images/slider-image/A-clear-image-of-a-woman-wearing-red-sharpened-by-Fotors-image-sharpener.jpg" // Random avatar image
              alt="Profile"
              className="w-10 h-10 rounded-full border border-gray-500 cursor-pointer"
              onClick={() => handleNavigate("/serviceprofile")}
            />
          </div>
        </header>
        ...
        <main className="p-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div onClick={() => handleNavigate("/serviceprofile")} className="bg-white shadow-md p-6 rounded-lg border border-gray-300 transform transition-transform hover:scale-105 hover:shadow-lg cursor-pointer">
              <div className="flex flex-col items-center">
                <FaUser className="text-[#1F4A9B] text-4xl mb-4" />
                <h3 className="text-lg font-bold text-[#1F4A9B]">Profile Overview</h3>
                <p className="text-gray-700 text-center">Update your personal information and profile picture.</p>
              </div>
            </div>
            <div onClick={() => handleNavigate("/allrequests")} className="bg-white shadow-md p-6 rounded-lg border border-gray-300 transform transition-transform hover:scale-105 hover:shadow-lg cursor-pointer">
              <div className="flex flex-col items-center">
                <FaTools className="text-[#1F4A9B] text-4xl mb-4" />
                <h3 className="text-lg font-bold text-[#1F4A9B]">Manage Requests</h3>
                <p className="text-gray-700 text-center">Respond to customer service requests.</p>
              </div>
            </div>
            <div onClick={() => handleNavigate("/addservice")} className="bg-white shadow-md p-6 rounded-lg border border-gray-300 transform transition-transform hover:scale-105 hover:shadow-lg cursor-pointer">
              <div className="flex flex-col items-center">
                <FaPlusCircle className="text-[#1F4A9B] text-4xl mb-4" />
                <h3 className="text-lg font-bold text-[#1F4A9B]">Add New Service</h3>
                <p className="text-gray-700 text-center">Expand your service offerings.</p>
              </div>
            </div>
            <div onClick={() => handleNavigate("/notifications")} className="bg-white shadow-md p-6 rounded-lg border border-gray-300 transform transition-transform hover:scale-105 hover:shadow-lg cursor-pointer">
              <div className="flex flex-col items-center">
                <FaBell className="text-[#1F4A9B] text-4xl mb-4" />
                <h3 className="text-lg font-bold text-[#1F4A9B]">Notifications</h3>
                <p className="text-gray-700 text-center">View and manage your notifications.</p>
              </div>
            </div>
          </div>
        </main>
